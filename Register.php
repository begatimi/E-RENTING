...
<body>
	...
	<header>
		...
		<a href=Register.php?lang=al><img src="Images/shqip.jpg"  style="margin-right:0.5%; margin-top:10px; height:25px; width:25px; float:right;"/></a>
		<a href=Register.php?lang=en><img src="Images/anglisht.jpg" style="margin-right:0.5%; margin-top:10px; height:25px; width:25px; float:right;"/></a>
	...
	<div id="Register">
	<h2 style ="margin-left:10px" ><?php echo $lang['Register_Account']; ?> </h2>		
